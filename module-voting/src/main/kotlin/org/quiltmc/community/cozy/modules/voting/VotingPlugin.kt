...
/**
 * Plugin containing the [VotingPlugin], providing tools for internal voting.
 */
@WiredPlugin(
	id = VotingPlugin.id,
...
public class VotingPlugin(wrapper: PluginWrapper) : KordExPlugin(wrapper) {
	override suspend fun setup() {
// TODO: We can't really use the plugin system just yet since it doesn't currently support any configuration tooling
//        extension(::VotingExtension)
	}

	public companion object {
		public const val id: String = "quiltmc-voting"
	}
}
